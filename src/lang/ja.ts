const root = ({
  ...
  "settings-image-description": "Specify the image to be used as a sprite sheet by URL or file name (namespace <var>File:</var> is unnecessary).",
  "settings-size-description": "Specifies the height and width of each sprite. This value is overridden by <var>width</var> and <var>height</var>.",
  "settings-width-description": "Specifies the width of each sprite. This value overrides <var>size</var>.",
  "settings-height-description": "Specifies the height of each sprite. This value overrides <var>size</var>.",
  "settings-classname-description": "Specifies an HTML class that is common to all sprites; e.g. <code>inv-sprite</code>.",
